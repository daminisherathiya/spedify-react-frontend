...
import { Flags_us, Flags_de, Img_01, Img_02, Img_03, Img_04, Img_05, home_icon, Avatar_1, Avatar_2, Avatar_3, Avatar_4, Avatar_5, Avatar_6, Avatar_7, Avatar_8, Avatar_9, Avatar_10, Avatar_11, Avatar_12 } from "../../components/imagepath";
            ...
            <div className="col-xl-9 col-md-8">
              <nav className="user-tabs mb-4">
                <ul className="nav nav-tabs nav-tabs-bottom nav-justified">
                  ...
                  <li className="nav-item">
                    <Link className="nav-link " to="invited-favourites">
                      Invited Freelancers
                    </Link>
                  </li>
                </ul>
                            ...
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">George Wells</Link>
                                  </h3>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">Timothy Smith</Link>
                                  </h3>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">Janet Paden</Link>
                                  </h3>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">James Douglas</Link>
                                  </h3>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">Floyd Lewis</Link>
                                  </h3>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">Jacqueline Daye</Link>
                                  </h3>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">Crystal Kemper</Link>
                                  </h3>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">Tony Ingle</Link>
                                  </h3>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">Kathleen Kaiser</Link>
                                  </h3>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">Veronica Cheek</Link>
                                  </h3>
                                  <div className="freelance-specific">
                                    Software Architect
                                  </div>
                          ...
                          <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="freelance-widget">
                              <div className="freelance-content">
                                ...
                                <div className="freelance-info">
                                  <h3>
                                    <Link to="userDetails.html">Mickey Bernier</Link>
                                  </h3>
