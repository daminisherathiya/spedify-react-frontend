    ...
    try {
      ...
      if (Object.keys(diffs).length) {
        ...
        if (userProfile.File) {
          ...
          const doc = (
            await Post(`api/v1/files/upload`, fd, {
        ...
        dispatch({
          type: "LOGIN",
          payload: { ...payload, picture: userProfile.picture },
        });
      }
    } catch (error) {}
  };
                ...
                <nav aria-label="breadcrumb" className="page-breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item" aria-current="page">
                      {enumsState.UserRoles && userProfile.userType
                        ? (enumsState.UserRoles || []).find(
                            (e) => e.value === userProfile.userType
                          ).text
                        : ""}
                    </li>
                    <li className="breadcrumb-item" aria-current="page">
                      ...
                      <div className="row">
                        <div className="form-group col-md-12">
                          ...
                          <input
                            ...
                            type="text"
                            className="form-control"
                            defaultValue={userProfile.addressLine}
                          />
                        </div>
                        <div className="form-group col-md-6">
                          <label>State</label>
                      ...
                      <div className="row">
                        ...
                        <div className="form-group col-md-6">
                          ...
                          <input
                            ...
                            type="text"
                            className="form-control"
                            defaultValue={userProfile.dribble}
                          />
                        </div>
                        <div className="form-group col-md-6">
                          <label>Twitter</label>
                        ...
                        <div className="form-group col-md-6">
                          ...
                          <input
                            ...
                            type="text"
                            className="form-control"
                            defaultValue={userProfile.likedin}
                          />
                        </div>
                        <div className="form-group col-md-6">
                          <label>Behance</label>
                          <input
                            ...
                            type="text"
                            className="form-control"
                            defaultValue={userProfile.behance}
                          />
                        </div>
                      </div>
                    </div>
