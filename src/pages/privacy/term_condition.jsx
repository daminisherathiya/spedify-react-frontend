                ...
                <div className="col-md-8">
                  <div className="terms-content">
                    <div className="terms-text">
                      <h4>Welcome to Spedify</h4>
                      <p>
                        Thanks for using our products and services ("Services"). The
                        Services are provided by Pixeel Ltd. ("Spedify"), located at 153
                    ...
                    <div className="terms-text">
                      ...
                      <p>
                        When you register for a Spedify account we collect your full
                      ...
                      <p>
                        When you use the "Remember Me" feature of Spedify Checkout, we
                        collect your email address, payment card number, CVC code and
                        expiration date.
                      </p>
                      <p>
                        When you respond to Spedify emails or surveys we collect your
                        ...
                        Spedify. If you contact us by phone as a Spedify User, we may
