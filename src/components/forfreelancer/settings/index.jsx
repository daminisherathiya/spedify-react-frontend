                ...
                <form >
                    ...
                    <div className="col-md-12 col-xl-4 d-flex">
                      <div className="pro-card flex-fill mb-3">
                        <div className="pro-head">
                          ...
                          <Link to="#" className="btn fund-btn skill-add">
                            Add More
                          </Link>
                        </div>
                    ...
                    <div className="col-md-12 col-xl-8">
                      <div className="card">
                        <div className="pro-head">
                          ...
                          <Link to="#" className="btn fund-btn add-award">
                            Add More
                          </Link>
                        </div>
                      ...
                      <div className="card">
                        <div className="pro-head">
                          ...
                          <Link to="#" className="btn fund-btn add-lang">
                            Add More
                          </Link>
                        </div>
                  ...
                  <div className="card">
                    <div className="pro-head">
                      ...
                      <Link to="#" className="btn fund-btn add-exp">
                        Add More
                      </Link>
                    </div>
                    <div className="pro-body">
                  ...
                  <div className="card">
                    <div className="pro-head">
                      ...
                      <Link to="#" className="btn fund-btn">
                        Add More Skills
                      </Link>
                    </div>
                    <div className="pro-body">
