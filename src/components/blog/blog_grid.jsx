...
// Import Images
import { Blog_01, Blog_02, Blog_03, Blog_04, Blog_05, Blog_06, Img_02, Img_03, Img_04, Img_05, Logo, home_icon } from "../imagepath"
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      ...
                      <h3 className="blog-title">
                        <Link to="/blog-details">
                          How to crack the interview easily - Spedify
                        </Link>
                      </h3>
                      <p className="mb-0">
                        Lorem ipsum dolor sit amet, consectetur em adipiscing elit,
