...
import { Logo, Logo_img, Logo_white, logo_five, } from '../imagepath';
      ...
      <header className={`header header-five ${navbar ? 'sticky' : ''} `}  >
        <nav className="navbar navbar-expand-lg header-nav">
            ...
            <div className="main-menu-wrapper">
              ...
              <ul className="main-nav">
                ...
                <li className={`has-submenu ${pathname === "developer" || pathname === "developer-details" || pathname === "dashboard" ||
                  ...
                  <Link to="#" className={isSideMenu === "foremployers" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu === "foremployers" ? "" : "foremployers")} onMouseEnter={() => setSideMenu("foremployers")}> For Employers<i className="fas fa-chevron-down" /></Link>
                    ...
                    <ul className="submenu">
                      <li className={`has-submenu ${pathname === "developer" || pathname === "developer-details" ? "active" : ""}`}>
                        ...
                        {isSideMenu1 === "freelancer" ?
                          <ul className="submenu"style={{ display: isSideMenu === 'foremployer' ? 'block' : 'none' }}>
                ...
                <li className={`has-submenu ${pathname === "project" || pathname === "project-details" || pathname === "freelancer-dashboard" || pathname === "company-profile" ||
                  ...
                  <Link to="#" className={isSideMenu === "forfreelancer" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu === "forfreelancer" ? "" : "forfreelancer")} onMouseEnter={() => setSideMenu("forfreelancer")}>  For Freelancer<i className="fas fa-chevron-down" /></Link>
                ...
                <li className={`has-submenu ${pathname === "about" || pathname === "blank-page" || pathname === "404-page" ||
                  ...
                  <Link to="#" className={isSideMenu === "pages" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu === "pages" ? "" : "pages")} onMouseEnter={() => setSideMenu("pages")}>Pages <i className="fas fa-chevron-down" /></Link>
                  {isSideMenu === "pages" ?
                    ...
                    <ul className="submenu"style={{ display: isSideMenu === 'pages' ? 'block' : 'none' }}>
                      ...
                      <li className={pathname === "onboard-screen" ? "active" : ""} onClick={Reload5}>
                ...
                <li className={`has-submenu ${pathname === "blog-list" || pathname === "blog-grid" ||
                  ...
                  <Link to="#" className={isSideMenu === "blog" ? "subdrop" : ""} onClick={() => toggleSidebar(isSideMenu === "blog" ? "" : "blog")} onMouseEnter={() => setSideMenu("blog")}>Blog <i className="fas fa-chevron-down" /></Link>
                  {isSideMenu === "blog" ?
            ...
            <ul className="nav header-navbar-rht">	
						<li className="sign-reg"><Link to="/login" className="log-btn"> Sign in</Link> <span className="space-login">/</span><Link to="/register" className="log-btn"> Register</Link></li>
