...
import { logo_four, key_01, Logo, Logo_white, Reg_icon_04, Logo_img } from '../imagepath';
              ...
              <li className={`has-submenu ${pathname === "about" || pathname === "blank-page" || pathname === "404-page" ||
                ...
                {isSideMenu === "pages" ?
                  ...
                  <ul className="submenu"style={{ display: isSideMenu === 'pages' ? 'block' : 'none' }} >
                    ...
                    <li className={pathname === "onboard-screen" ? "active" : ""} onClick={Reload4}>
          ...
          <ul className="nav header-navbar-rht sign-page">
            <li>
              <Link to="/login" className="log-btn">
                <img src={Reg_icon_04} className="me-1" alt="icon" />{" "}
                Sign in
              </Link>{" "}
