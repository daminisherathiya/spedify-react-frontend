    ...
    <div>
      <SRLWrapper >
        ...
        <div className="col-sm-6 col-md-6 col-lg-4 col-xl-3">
          <div className="project-widget ">
            <div className="pro-image">		
              <Link  to={Project_Copy} data-fancybox="gallery2">
                <img className="img-fluid" alt="User Image" src={Project_Copy} />
              </Link>
            </div>
            <div className="project-footer">
              <div className="d-flex align-items-center">
        ...
        <div className="col-sm-6 col-md-6 col-lg-4 col-xl-3">
          <div className="project-widget">
            <div className="pro-image">		
              <Link  to={Project_11_1} data-fancybox="gallery2">
                <img className="img-fluid" alt="User Image" src={Project_11_1} />
              </Link>
            </div>
            <div className="project-footer">
              <div className="d-flex align-items-center">
