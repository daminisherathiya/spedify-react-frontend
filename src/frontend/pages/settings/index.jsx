...
const Settings = (props) => {
  ...
  const userState = state.user || { userType: 0 };
  useEffect(() => {
              ...
              <div className="breadcrumb-list">
                <nav aria-label="breadcrumb" className="page-breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item" aria-current="page">{(enumsState.UserRoles && userState.userType) ? (enumsState.UserRoles || []).find(e => e.value === userState.userType).text : ''}</li>
