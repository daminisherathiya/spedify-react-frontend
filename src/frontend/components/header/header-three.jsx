...
import { Logo, Logo_img, Logo_white, Top_icon, logo_three } from '../imagepath';
      ...
      <header className={`header header-three ${navbar ? 'sticky' : ''} `}  >
        <nav className="navbar navbar-expand-lg header-nav">
              ...
              <li className={`has-submenu ${pathname === "about" || pathname === "blank-page" || pathname === "404-page" ||
                ...
                {isSideMenu === "pages" ?
                  ...
                  <ul className="submenu" style={{ display: isSideMenu === 'pages' ? 'block' : 'none' }} >
                    ...
                    <li className={pathname === "onboard-screen" ? "active" : ""} onClick={Reload3}>
          ...
          <ul className="nav header-navbar-rht">
            <li><Link to="/login" className="log-btn"> Sign in</Link> <span className="space-login">/</span><Link to="/register" className="log-btn"> Join us</Link></li>
