...
import { Review_01, Review_02, Review_03, Review_1, home_icon, loader_icon } from "../../imagepath";
                ...
                <div className="card-body">
                  <div className="reviews">
                    <div className="review-content no-padding">
                      ...
                      <p className="mb-0">
                        Great clarity in specification and communication. I got payment
                        really fast. Really recommend this employer for his
