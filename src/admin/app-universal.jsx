...
import SubCategories from './component/pages/categories/sub-category';
...
const AppUniversal = function (props) {
	...
	return (
			...
			<Router basename={`${config.publicPath}`}>
				...
				<Route path="/admin/earning-employer" exact component={EarningEmployer} />
				<Route path="/admin/earning-freelancer" exact component={EarningFreelancer} />
				<Route path="/admin/bid-fees" exact component={BidFees} />
				<Route path="/admin/contest-entry-fees" exact component={ContestEntryFees}/>
